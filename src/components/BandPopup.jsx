...
export default function BandPopup({ onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!nomorKontak.trim()) { errors.push('Nomor Kontak'); valid = false; }
    ...
    try {
      ...
      await fetch(SCRIPT_URL, {
        ...
        mode: 'no-cors',
      }).catch(() => console.log('Mock request success'));
        ...
        <div className="band-desc-section">
          <div className="band-glass-card full" style={{ marginBottom: '24px' }}>
            ...
            <p className="band-card-text">
              Selamat datang di <strong style={{ color: 'var(--gold)' }}>Band Competition I-Fest 6.0!</strong> Kompetisi ini menjadi wadah bagi masyarakat di Kota Palembang untuk menyalurkan kreativitas, bakat, serta minat dalam bidang musik.<br /><br />
        ...
        <form onSubmit={handleSubmit}>
          <div className="band-form-wrapper">
            ...
            <div className="band-form-step">
              ...
              <div className="band-field-group">
                <label className="band-label">Nomor Kontak <span className="req">*</span></label>
                <input className="band-input" type="text" inputMode="numeric" pattern="[0-9]*" placeholder="Masukkan nomor kontak Anda..." value={nomorKontak} onChange={e => setNomorKontak(e.target.value.replace(/\D/g, ''))} required />
              </div>
            </div>
                  ...
                  <div key={m.id} className={`band-member-box ${!isRequired ? 'optional' : ''}`}>
                    ...
                    <div className="band-field-group">
                      ...
                      <div className="band-radio-grid">
                        {['Vocalist', 'Gitaris', 'Bassist', 'Keyboardist', 'Cajon', 'Other'].map(role => (
